...
# OTRAS ORDENES
#
#   ./qemu-secure-lab-1.0.0-ES.sh <orden>
#
...
# Generado por qemu-secure-lab-1.0.0-ES.sh
# Se retira con: ./qemu-secure-lab-1.0.0-ES.sh uninstall
#
...
case "${1:-}" in
  ...
  -h|--help|help)
    cat <<EOF
qemu-secure-lab-1.0.0-ES.sh $SCRIPT_VERSION
